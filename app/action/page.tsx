    ...
    <div className="h-full overflow-auto pb-8">
      <Tabs defaultValue="goals" className="w-full">
        <TabsList className="grid w-full grid-cols-5">
          ...
          <TabsTrigger value="habits">习惯培养</TabsTrigger>
        ...
        <TabsContent value="habits" className="space-y-4 mt-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <Card>
              <CardHeader className="pb-2">
                <div className="flex items-center justify-between">
                  <CardTitle className="text-lg">习惯蓝图设计</CardTitle>
                  <GitBranch className="h-5 w-5 text-blue-500" />
                </div>
                <CardDescription>科学习惯模板库与可视化习惯链条</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-3">
                  <div className="space-y-2">
                    <div className="text-sm font-medium">活跃习惯</div>
                    <div className="space-y-2">
                      <div className="p-2 border rounded">
                        <div className="flex items-center justify-between mb-1">
                          <span className="text-sm font-medium">每日阅读</span>
                          <Badge variant="outline" className="bg-green-50 text-green-700">
                            连续21天
                          </Badge>
                        </div>
                        ...
                        <div className="mt-2 flex space-x-1">
                          {Array(7)
                            .fill(0)
                            .map((_, i) => (
                              <div key={i} className="h-4 w-4 rounded-sm bg-green-100 border border-green-300"></div>
                            ))}
                        </div>
                      </div>
                      ...
                      <div className="p-2 border rounded">
                        ...
                        <div className="mt-2 flex space-x-1">
                          {Array(5)
                            .fill(0)
                            .map((_, i) => (
                              <div key={i} className="h-4 w-4 rounded-sm bg-blue-100 border border-blue-300"></div>
                            ))}
                          {Array(2)
                            .fill(0)
                            .map((_, i) => (
                              <div key={i} className="h-4 w-4 rounded-sm bg-gray-100 border border-gray-300"></div>
                            ))}
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="space-y-2">
                    <div className="text-sm font-medium">习惯DNA双螺旋</div>
                    <div className="h-20 bg-blue-50 rounded border relative">
                      <div className="absolute inset-0 flex items-center justify-center">
                        <Dna className="h-12 w-12 text-blue-500 opacity-50" />
                      </div>
                    </div>
                    <div className="text-xs text-center text-muted-foreground">
                      连续打卡天数生成「习惯DNA双螺旋」模型
                    </div>
                  </div>
                </div>
              </CardContent>
              <CardFooter className="pt-0">
                <span className="text-xs text-muted-foreground">提供科学习惯模板库，支持自定义习惯规则</span>
              </CardFooter>
            </Card>
            ...
            <Card>
              <CardHeader className="pb-2">
                <div className="flex items-center justify-between">
                  <CardTitle className="text-lg">阻力预警系统</CardTitle>
                  <AlertTriangle className="h-5 w-5 text-amber-500" />
                </div>
                <CardDescription>识别习惯冲突与情绪能量预警</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-3">
                  <div className="space-y-2">
                    <div className="text-sm font-medium">习惯冲突检测</div>
                    <div className="p-2 border rounded bg-amber-50">
                      <div className="flex items-center text-sm text-amber-800 mb-1">
                        <AlertTriangle className="h-4 w-4 mr-1" />
                        <span className="font-medium">检测到时间冲突</span>
                      </div>
                      <div className="text-xs text-amber-700">
                        <p>新设健身计划 (晚上7:00-8:00)</p>
                        <p>与现有加班时段 (晚上6:30-9:00) 重叠</p>
                      </div>
                  ...
                  <div className="space-y-2">
                    <div className="text-sm font-medium">情绪能量预警</div>
                    <div className="p-2 border rounded bg-blue-50">
                      <div className="flex items-center text-sm text-blue-800 mb-1">
                        <Zap className="h-4 w-4 mr-1" />
                        <span className="font-medium">能量水平预警</span>
                      </div>
                      <div className="text-xs text-blue-700">
                        <p>今日情绪能量低于阈值 (65/100)</p>
                        <p>已自动降级当日习惯要求</p>
                      </div>
            ...
            <Card>
              <CardHeader className="pb-2">
                <div className="flex items-center justify-between">
                  <CardTitle className="text-lg">社群监督机制</CardTitle>
                  <Users className="h-5 w-5 text-purple-500" />
                </div>
                <CardDescription>组队打卡与习惯实验室</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-3">
                  <div className="space-y-2">
                    <div className="flex items-center">
                      <Globe className="h-4 w-4 mr-2 text-blue-500" />
                      <span className="text-sm font-medium">习惯联盟</span>
                    </div>
                    <div className="pl-6 text-xs text-muted-foreground">
                      外交部开放「习惯联盟」功能，组队打卡共享奖励
                    </div>
                    <div className="pl-6 p-2 border rounded bg-blue-50">
                      <div className="text-sm font-medium mb-1">晨型人联盟</div>
                      <div className="flex items-center justify-between text-xs">
                        <span>成员: 5人</span>
                        <span>完成率: 85%</span>
                      </div>
                      <div className="mt-2 flex space-x-1">
                        <div className="h-6 w-6 rounded-full bg-green-100 flex items-center justify-center text-xs font-medium text-green-800">
                          A
                        </div>
                        <div className="h-6 w-6 rounded-full bg-green-100 flex items-center justify-center text-xs font-medium text-green-800">
                          B
                        ...
                        <div className="h-6 w-6 rounded-full bg-red-100 flex items-center justify-center text-xs font-medium text-red-800">
                          D
                        </div>
                        <div className="h-6 w-6 rounded-full bg-green-100 flex items-center justify-center text-xs font-medium text-green-800">
                          E
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center">
                      <BookOpen className="h-4 w-4 mr-2 text-purple-500" />
                      <span className="text-sm font-medium">习惯实验室</span>
                    </div>
                    <div className="pl-6 text-xs text-muted-foreground">
                      研发部提供「习惯实验室」：AB测试不同习惯养成策略
                    </div>
                    <div className="pl-6 p-2 border rounded bg-purple-50">
                      <div className="text-sm font-medium mb-1">当前实验: 阅读习惯</div>
                      <div className="grid grid-cols-2 gap-2 text-xs">
                        <div className="p-1 bg-white rounded">
                          <div className="font-medium">方案A: 固定时间</div>
                          <div className="text-muted-foreground">每天早上7:00</div>
                          <div className="mt-1">完成率: 65%</div>
                        </div>
                        <div className="p-1 bg-white rounded">
                          <div className="font-medium">方案B: 场景触发</div>
                          <div className="text-muted-foreground">晨间咖啡后立即</div>
                          <div className="mt-1">完成率: 82%</div>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <CardFooter className="pt-0">
                <span className="text-xs text-green-600">实验结论: 场景触发比固定时间更有效</span>
              </CardFooter>
            </Card>
            ...
            <Card>
              <CardHeader className="pb-2">
                <div className="flex items-center justify-between">
                  <CardTitle className="text-lg">激励设计</CardTitle>
                  <Trophy className="h-5 w-5 text-yellow-500" />
                </div>
                <CardDescription>习惯勋章墙与基因进化系统</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-3">
                  <div className="space-y-2">
                    <div className="flex items-center">
                      ...
                      <span className="text-sm font-medium">习惯勋章墙</span>
                    </div>
                    <div className="pl-6 text-xs text-muted-foreground">达成阶段性目标解锁特殊勋章</div>
                    <div className="pl-6 flex space-x-2">
                      <div className="h-10 w-10 rounded-full bg-gradient-to-r from-amber-400 to-amber-600 flex items-center justify-center">
                        <span className="text-xs text-white font-bold">百日</span>
                      </div>
                      <div className="h-10 w-10 rounded-full bg-gradient-to-r from-blue-400 to-blue-600 flex items-center justify-center">
                        <span className="text-xs text-white font-bold">钢铁</span>
                      </div>
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center">
                      <Dna className="h-4 w-4 mr-2 text-purple-500" />
                      <span className="text-sm font-medium">基因进化系统</span>
                    </div>
                    <div className="pl-6 text-xs text-muted-foreground">长期坚持的习惯可转化为「本能技能」</div>
                    <div className="pl-6 p-2 border rounded bg-purple-50">
                      <div className="text-sm font-medium mb-1">进化中的习惯</div>
                      <div className="space-y-2 text-xs">
                        <div className="flex items-center justify-between">
                          <span>晨间冥想</span>
                          <div className="flex items-center">
                            <span>进化进度:</span>
                            <Progress value={65} className="h-1.5 w-16 ml-1" />
                          </div>
                        </div>
                        <div className="flex items-center justify-between">
                          <span>每日阅读</span>
                          <div className="flex items-center">
                            <span>进化进度:</span>
                            <Progress value={85} className="h-1.5 w-16 ml-1" />
                          </div>
                        </div>
                      </div>
                    </div>
              ...
              <CardFooter className="pt-0">
                <span className="text-xs text-muted-foreground">习惯进化后将永久提升CEO基础属性</span>
              </CardFooter>
            </Card>
          </div>
        </TabsContent>
